...
arithmetic.  Although the technique is not guaranteed to succeed or terminate, we have used it to successfully synthesize a range of programs over non-trivial contracts.  \mike{What is our ``hook''?  Why is this *better* than other approaches to synthesis - this (unwritten) sentence is critically important}.
