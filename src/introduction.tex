...
\begin{itemize}
	\item To the best of our knowledge, the first template-free procedure modulo
	infinite theories, to synthesize implementations from Assume-Guarantee
	contracts containing temporal safety properties
