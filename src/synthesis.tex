...
1~\footnote{The proofs can be found at https://github.com/andrewkatis/Coq}.
...
present its actual form\footnote{The implementation for the
example is available at }.
The main idea involves the redefinition of each variable in the model as an array of size equal to the proof's length $k$, and,
