...
\author{Andreas Katis\inst{1}, Grigory Fedyukovich\inst{2}, Arie
...
\begin{abstract}
\grigory{version of the abstract:}
...
Furthermore, we developed a compiler to translate these primitive implementations to the C
language.
For a vast variety of models, we test their corresponding
implementations against the ones provided by LustreC, a compiler from Lustre to
C implementations, yielding comparable results.
\grigory{There is a need to the final sentence.. something like ``our C-implementations are better than the ones by  'LustreC.'}
\qed
