...
\footnote{More info about \aeval can be found
  at~\url{http://www.inf.usi.ch/phd/fedyukovich/niagara}.}\arie{Consider
  removing this footnote since there is a section on \aeval already}.
...
work. \arie{Elaborate a little on the semantics used. The Skolem
  functions are over Reals, but the compiled C code is probably over
  floats. Both overflows and numerical errors can present a
  problem. This can be mitigated by integrating some testing
  methodology into synthesis.}
